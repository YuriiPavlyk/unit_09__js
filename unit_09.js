...
function f4() {
    ...
    out4.innerHTML = this.classList.toggle('bg-orange');
}
...
function f5() {
    ...
    if(out4.getAttribute('bg-orange')){
        out.innerHTML = true;
    }
    else{
        out.innerHTML = false;
...
function f8() {
    ...
    for(let i = 0; i < blocks8.length; i++){
        out[i].innerHTML = this.classList.toggle('bg-orange');
    }
...
function f12() { 
    out.appendChild(div12).classList.add('bg-orange');
}
...
function f13() { 
    out13.appendChild(div13).classList.add('bg-orange');
}
...
function f14() {
    out14.appendChild(div14).classList.add('bg-orange');
}
